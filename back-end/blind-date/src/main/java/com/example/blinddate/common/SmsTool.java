...
public class SmsTool {
    ...
    static final String accessKeyId = "LTAI5tSLnWLUVojLGkDpVwkX";
    static final String accessKeySecret = "WdE9hx5amH5Y78nTp7e0Qne5QrWmxv";
    ...
    public static SendSmsResponse sendSms(String phone , String code, String TemplateCode) throws ClientException {
        ...
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("APP注册账号发送验证码");
        //必填:短信模板-可在短信控制台中找到
